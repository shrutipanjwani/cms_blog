        ...
        <div class="main-container">
            ...
            <div class="side-container">
                <ul class="navbar-nav ml-auto">
                    <form class="form-inline d-none d-sm-block" action="blog.php?page=1" method="post">
                            ...
                            <ul class="posts-list">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <small><?php echo htmlentities($DateTime); ?> | By 
                                    <a href="myprofile.php?username=<?php echo htmlentities($User); ?>"><?php echo htmlentities($User); ?></a></small>
                                    </div>
                                </div>
                                <?php } ?>
                            </ul>
